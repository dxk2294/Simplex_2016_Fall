...
namespace Simplex
{
	...
	class MyOctant
	{
		static uint uMyOctantCount; //will store the number of octants instantiated
		static uint uMaxLevel;//will store the maximum level an octant can go to
		static uint uIdealEntityCount; //will tell how many ideal Entities this object will contain
		...
		std::vector<MyOctant*> m_lChildAndEmpty; //list of all nodes (this will be applied to root only)
	...
	public:
		...
		*/
		...
		OUTPUT: class object
		*/
		MyOctant(vector3 a_v3Center, float a_fSize, MyOctant* parent);
		/*
		...
		*/
		...
		OUTPUT: ---
		*/
		void Display(vector3 a_v3Color = C_YELLOW, bool displayLeafs = true);
		/*
		...
		*/
		...
		/*
		USAGE: Generates the model matrix for this octant
		ARGUMENTS: ---
		OUTPUT: ---
		*/
