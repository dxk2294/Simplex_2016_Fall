...
Date: 2017/07
----------------------------------------------*/
#ifndef __DJKENTITYMANAGER_H_
#define __DJKENTITYMANAGER_H_
...
namespace Simplex
{
	...
	class DJKEntityManager
	{
		...
		static DJKEntityManager* m_pInstance; // Singleton pointer
	public:
		bool m_bCheckCollisions = true; //Whether to check collisions in octree
		MyOctant* active_octree = nullptr;
		/*
		Usage: Gets the singleton pointer
		Arguments: ---
		Output: singleton pointer
		*/
		static DJKEntityManager* GetInstance();
		/*
	...
	private:
		...
		*/
		DJKEntityManager(void);
		/*
		Usage: copy constructor
		Arguments: class object to copy
		Output: class object instance
		*/
		DJKEntityManager(DJKEntityManager const& a_pOther);
		/*
		Usage: copy assignment operator
		Arguments: class object to copy
		Output: ---
		*/
		DJKEntityManager& operator=(DJKEntityManager const& a_pOther);
		/*
		Usage: destructor
		Arguments: ---
		Output: ---
